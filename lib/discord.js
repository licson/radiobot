module.exports = function (bridge) {
	bridge.allOnce(['config', 'makeLog', 'URLHandlers', 'queue', 'doQueueSong', 'songList', 'addToSongList', 'doTTS', 'opus_stream', 'volume', 'mixer'],
	function (config, makeLog, URLHandlers, queue, doQueueSong, songList, addToSongList, doTTS, opus_stream, volume, mixer) {
		...
		var proxiedOpusStream = new AbortStream(config.opus.bitrate * 1000 * 8, config.opus.bitrate * 1000 * 4);
