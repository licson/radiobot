module.exports = function (bridge) {
	bridge.allOnce(['get_router', 'mixer', 'queue', 'config'], function (getRouter, mixer, queue, config) {
		...
		let opusIdentificationHeader = null;
		let opusCommentHeader = null;
		...
		function headerCatcher (data) {
			...
			console.log(opusIdentificationHeaderPos, opusCommentHeaderrPos, firstSoundPacketPos)
			console.log(opusIdentificationHeader.toString(), opusCommentHeader.toString())
		...
		router.get('/live.ogg', function (req, res) {
